          ...
          <div className="grid md:grid-cols-3 gap-8">
            {solutions.map((sol, i) => (
              <motion.div
                ...
                className="bg-card rounded-lg border border-border card-hover flex flex-col"
              >
                <div className="p-8 flex-1">
                  <span className="text-xs font-semibold uppercase tracking-wider text-accent">{sol.tag}</span>
                  <h3 className="font-serif font-bold text-xl text-foreground mt-2 mb-3">{sol.title}</h3>
