            ...
            <Card key={kpi.label} className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardContent className="p-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className={`h-8 rounded-lg flex items-center justify-center px-2 ${kpi.bgClass}`}>
                    <kpi.icon className={`w-4 h-4 shrink-0 ${kpi.colorClass}`} />
                  </div>
                  <span className="text-[10px] font-bold uppercase tracking-wider opacity-70 whitespace-nowrap">
