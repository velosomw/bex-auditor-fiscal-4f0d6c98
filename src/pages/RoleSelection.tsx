    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[hsl(222,30%,12%)] via-[hsl(220,40%,18%)] to-[hsl(222,25%,15%)] px-4">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-10">
          ...
          <p className="text-[hsl(220,15%,55%)]">Escolha como deseja acessar a plataforma</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <motion.button
              ...
              className="group bg-[hsl(222,25%,18%)]/80 backdrop-blur-sm border border-[hsl(222,20%,25%)] rounded-2xl p-8 text-left hover:border-[hsl(217,60%,50%)] hover:bg-[hsl(222,25%,20%)]/80 transition-all duration-300 hover:-translate-y-1"
            >
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-5" style={{ backgroundColor: `${item.color}20` }}>
