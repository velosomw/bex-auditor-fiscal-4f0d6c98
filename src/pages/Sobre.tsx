          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Com escritórios em São Paulo e Alphaville, a BEX Auditoria combina experiência prática com metodologias reconhecidas internacionalmente para garantir resultados concretos e sustentáveis.
              </p>
            </motion.div>
            <motion.img
              initial={{ opacity: 0, x: 30 }}
