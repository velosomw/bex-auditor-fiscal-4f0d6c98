...
const papers = [
  {
    title: "Reestruturação Financeira: Guia Prático para PMEs",
  ...
  {
    title: "Estudo Global de Sustentabilidade Corporativa",
    date: "15 de Fevereiro de 2026",
    image: paper2,
  },
  {
    title: "Novas regras de tributação da pessoa física",
    date: "16 de Janeiro de 2026",
    image: paper3,
  },
  {
    title: "Legislação & Tributos - Janeiro 2026",
  ...
  return (
    <section className="section-padding bg-background">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-serif font-bold text-foreground mb-10">
          Pappers
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          >
            <Link
              to="/insights"
              className="group relative block rounded-2xl overflow-hidden h-full min-h-[400px] md:min-h-0"
            >
              <img
                src={papers[0].image}
                alt={papers[0].title}
              ...
              <div className="relative z-10 flex flex-col justify-between h-full p-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary-foreground/60 uppercase tracking-wide mb-4">
                    {papers[0].date}
                  </p>
          ...
          {papers.slice(1).map((paper, i) => (
            ...
            >
              <Link
                to="/insights"
                className="group block rounded-2xl overflow-hidden bg-card shadow-sm hover:shadow-xl transition-shadow duration-300 h-full"
              >
                ...
                <div className="p-5 flex flex-col justify-between min-h-[160px]">
                  <div>
                    <h3 className="font-serif font-bold text-foreground text-base leading-snug mb-2 group-hover:text-accent transition-colors">
                      {paper.title}
                    </h3>
