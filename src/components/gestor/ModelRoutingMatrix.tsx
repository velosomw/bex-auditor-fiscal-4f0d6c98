...
const ROWS: ProcessRow[] = [
  {
    ...
    models: {
      low: { model: "gemini-3.1-flash-lite-preview", provider: "google" },
      medium: { model: "gemini-3.5-flash", provider: "google" },
      high: { model: "gemini-3.1-pro-preview", provider: "google" },
    },
    triggerForGpt5: null,
  },
  {
  ...
  },
  {
    ...
    models: {
      ...
      medium: { model: "gemini-3.1-pro-preview", provider: "google" },
